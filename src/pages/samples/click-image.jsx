...
export default function SsampleClickImage() {
    ...
    <>
      <GameLayout>
        ...
        <Hud>
          ...
          <Box>
            <Text textColor="blue.800">
              Parts of the image on this page are clickable. Positioning the
              clickable elements was done manually.
            </Text>
            <Text textColor="blue.800">
              Uses the pan/zoom library to ensure that the clickable elements
              are always in the correct places in the image for all screen
              sizes. It is a bit awkward but it works.
            </Text>
